...
interface InterviewSettingsFormProps {
  ...
  onChange: (values: IInterViewSettings) => void;
}

const InterviewSettingsForm: React.FC<InterviewSettingsFormProps> = ({ handleTab, onChange }) => {
  const {
    errors,
    touched,
    handleSubmit,
    ...
    onSubmit: (values) => {
      ...
      alert('Form summited succesfully')
    },
  });
  onChange(values);
